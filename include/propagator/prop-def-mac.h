	...
	propagateKernel<preci, V_##X>		<<<gridSize,blockSize,0,stream>>> ((const complex<preci> *) m, (complex<preci> *) v, (complex<preci> *) m2, \
											zR, z2, z4, zQ, gFac, eps, dp1, dp2, dzc, dzd, ood2, ood2p, (preci) LL, Lx, Sf, Vo, Vf, NN); \
