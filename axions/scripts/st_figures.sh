...
FILE="ploter3.gnu"
/bin/cat <<EOM > $FILE
set title "(N=$nnn, prec=?) z=$zzz" font "Helvetica,20" offset 0,-2 tc lt 1
...
ffmpeg -r 3 -start_number $NAME -i out/plots/str/st-%05d.png -c:v libx264 -r 30 -pix_fmt yuv420p out/st-movie.mp4
