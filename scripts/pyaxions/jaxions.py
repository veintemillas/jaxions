    ...
    if (something == 'stloops'):
        ...
        if ('/string/loops/' in f):
            ...
            duxs = {"lgt" : f['/string/loops/lengths/data'][()] ,
                ...
                "com_coords" : f['/string/loops/com_coords'][()],
                "origin" : f['/string/loops/origin'][()],
                "inertia_eigs" : f['/string/loops/inertia_eigs'][()] ,
                "inertia" : f['/string/loops/inertia'][()] ,
                "lengths" : f['/string/loops/llengths'][()] ,
...
def fildic(meas):
    ...
    if (meas in ['MEAS_PSP_A','PSP_A','energy power spectrum','energy power spectrum axion','psp','pspa','power spectrum']):
        return 'MEAS_PSP_A'
    if (meas in ['MEAS_PSP_S','PSP_S','energy power spectrum','energy power spectrum saxion','psp','psps','power spectrum']):
        return 'MEAS_PSP_S'
