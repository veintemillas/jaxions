...
plt.clf()
plt.semilogy(en[:,0],sca*(en[:,1:4].sum(axis=1))/16.82,   c='b',label=r'G\theta',linewidth=1,marker='.',markersize=0.1)
plt.semilogy(en[:,0],sca*(en[:,4])/16.82,                 c='k',label=r'V\theta',linewidth=1,marker='.',markersize=0.1)
plt.semilogy(en[:,0],sca*(en[:,5])/16.82,                 c='r',label=r'K\theta',linewidth=1,marker='.',markersize=0.1)
plt.semilogy(en[:,0],sca*(en[:,1:6].sum(axis=1))/16.82,   c='k',label=r'\theta',linewidth=1,marker='.',markersize=0.1)
plt.semilogy(en[:ik,0],sca[:ik]*(en[:ik,6:9].sum(axis=1))/16.82,   '--',c='b',label=r'G\rho',linewidth=0.5,marker='.',markersize=0.1)
plt.semilogy(en[:ik,0],sca[:ik]*(en[:ik,9])/16.82,                 '--',c='k',label=r'V\rho',linewidth=0.5,marker='.',markersize=0.1)
plt.semilogy(en[:ik,0],sca[:ik]*(en[:ik,10])/16.82,                '--',c='r',label=r'K\rho',linewidth=0.5,marker='.',markersize=0.1)
