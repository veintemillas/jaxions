...
void	propSimpleKernel(Scalar *field, const double dz, const double c, const double d, bool st, const int Ng)
{
...
void	propagateSimple(Scalar *field, const double dz, const int Ng)
{
	propSimpleKernel(field, dz, C1, D1, 0, Ng);
	propSimpleKernel(field, dz, C2, D2, 1, Ng);
	propSimpleKernel(field, dz, C3, D3, 0, Ng);
	propSimpleKernel(field, dz, C4, D4, 1, Ng);
}
