...
// Struc containing globals (initialised)
IOParms iop;
// link it to old names
hid_t       &meas_id  = iop.meas_id;
hid_t       &mlist_id = iop.mlist_id;
hsize_t     &tSize    = iop.tSize;
hsize_t     &slabSz   = iop.slabSz;
hsize_t     &sLz      = iop.sLz;
bool        &opened   = iop.opened;
bool        &header   = iop.header;
bool        &mDisabled= iop.mDisabled;
H5E_auto2_t &eFunc    = iop.eFunc;
void*       &cData    = iop.cData;
